...
class AI:
        ...
        messages = [
            {
                ...
                так же снизу сообщения напиши названия всех перечисленных  фильмов через ';', но сделай разделитель в своем сообщении (разделитель - "***") 
                тоесть твое сообщение поделится на две части: 1)фильмы с описанием, ***, 2)название фильмов
                """
            }
        ]
    ...
    async def get_filmName(self, text):
        messages = [
            {
                "role": "user",
                "content": f"Достань из текста названия фильмов: {text}. Напиши названия фильмов через ';'. Напиши мне только названия фильмов, ничего больше не пиши, только названия фильмов через разделитель"
            }
        ]
